...
export default function SiteSearch() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* RF INTELLIGENCE MAP — nationwide U.S. RF map, placed at the BOTTOM of the
          Map Suite pipeline so the SCIP section hierarchy stays intact. Isolated
          in its own error boundary so a map/WebGL hiccup can never blank the page. */}
      {coordsReady && sarfReady && zoningReady && (
