    ...
    <div className="min-h-screen bg-[#000000] bg-[radial-gradient(ellipse_120%_60%_at_50%_-10%,#232328_0%,#0c0c0e_45%,#000000_75%)] text-white font-body overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-gradient-to-b from-[#1a1a1e]/95 to-[#050505]/90 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block text-[10px] text-[#FDBA74]/70 leading-none tracking-widest uppercase">by SkyWave AI</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/pricing" className="px-5 py-2 rounded-xl bg-[#FDBA74] hover:bg-[#FFEDD5] text-[#000000] text-sm font-bold shadow-lg shadow-[#FDBA74]/20 transition-all">
              Get Started
            </Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-white/5 bg-[#000000] px-6 py-4 space-y-3 text-sm font-medium">
            ...
            <Link to="/pricing" className="block w-full text-center px-5 py-2.5 rounded-xl bg-[#FDBA74] text-[#000000] font-bold mt-2" onClick={() => setMenuOpen(false)}>Get Started</Link>
          </div>
        )}
      </nav>
      ...
      <section className="relative pt-32 pb-24 px-6 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 2 }}>
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full bg-[#FDBA74]/10 blur-[120px]" />
          <div className="absolute top-1/2 left-1/4 w-[300px] h-[300px] rounded-full bg-[#FDBA74]/5 blur-[80px]" />
        </div>

        <div className="relative max-w-4xl mx-auto" style={{ zIndex: 3 }}>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#FDBA74]/40 bg-[#FDBA74]/10 text-[#FDBA74] text-xs font-semibold tracking-wide mb-6">
          ...
          <h1 className="font-heading font-bold text-5xl md:text-7xl leading-tight text-white mb-6">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FDBA74] to-[#FFEDD5]">SiteHawk</span> with AI<br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/search"
              className="px-8 py-4 rounded-2xl bg-[#FDBA74] hover:bg-[#FFEDD5] text-[#000000] font-heading font-bold text-lg shadow-2xl shadow-[#FDBA74]/25 transition-all hover:scale-105"
            >
              ...
              {[
                ...
                <div key={c.label} className="rounded-xl border border-white/5 bg-white/5 p-4 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-[#FDBA74]">{c.label}</span>
                  ...
                  <div className="pt-1 space-y-1 border-t border-white/5">
                    <p className="text-[10px] text-[#FDBA74]/80">✈ {c.airport}</p>
                    <p className="text-[10px] text-[#FDBA74]/70">📡 {c.tower}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-widest text-[#FDBA74] font-bold mb-3">Everything You Need</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((f) => (
              <div key={f.title} className="rounded-2xl border border-white/5 bg-white/3 hover:bg-white/5 hover:border-[#FDBA74]/25 p-6 transition-all group">
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3 className="font-heading font-bold text-white text-lg mb-2 group-hover:text-[#FDBA74] transition-colors">{f.title}</h3>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-transparent to-[#121212]/60">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs uppercase tracking-widest text-[#FDBA74] font-bold mb-3">Simple 3-Step Process</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step} className="relative">
                <div className="text-[10px] font-black text-[#FDBA74]/50 tracking-widest mb-3">{s.step}</div>
      ...
      <section id="testimonials" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-widest text-[#FDBA74] font-bold mb-3">What Professionals Say</p>
      ...
      <section id="pricing" className="py-24 px-6 bg-gradient-to-b from-transparent to-[#121212]/40">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs uppercase tracking-widest text-[#FDBA74] font-bold mb-3">Simple Pricing</p>
          <h2 className="font-heading font-bold text-4xl text-white mb-4">Simple Pricing. One Mission.</h2>
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#FDBA74]/30 bg-[#FDBA74]/10 text-[#FDBA74] text-sm font-semibold mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 max-w-2xl mx-auto">
            {PLANS.map((p) => (
              <div key={p.name} className={`rounded-2xl border p-8 flex flex-col items-center gap-4 transition-all ${p.highlight ? "border-[#FDBA74]/50 bg-[#FDBA74]/10 shadow-2xl shadow-[#FDBA74]/10 scale-105" : "border-white/5 bg-white/3"}`}>
                {p.highlight && <span className="px-3 py-1 rounded-full bg-[#FDBA74] text-[#000000] text-xs font-bold">Most Popular</span>}
                ...
                <Link
                  to="/pricing"
                  className={`w-full text-center px-6 py-3 rounded-xl font-bold text-sm transition-all mt-2 ${p.highlight ? "bg-[#FDBA74] hover:bg-[#FFEDD5] text-[#000000] shadow-lg shadow-[#FDBA74]/20" : "border border-white/10 hover:border-white/25 text-white/70 hover:text-white"}`}
                >
                  {p.cta}
                </Link>
              </div>
          ...
          <Link to="/pricing" className="text-[#FDBA74] hover:text-[#FFEDD5] text-sm font-semibold underline underline-offset-4 transition-colors">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-3xl border border-[#FDBA74]/25 bg-gradient-to-b from-[#242428] via-[#101012] to-[#000000] p-12 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_25px_50px_-12px_rgba(255,199,44,0.08)]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/pricing"
                className="inline-flex items-center gap-2 px-10 py-4 rounded-2xl bg-[#FDBA74] hover:bg-[#FFEDD5] text-[#000000] font-heading font-bold text-lg shadow-2xl shadow-[#FDBA74]/25 transition-all hover:scale-105"
              >
                Start Free Trial 🦅
              </Link>
              <Link
