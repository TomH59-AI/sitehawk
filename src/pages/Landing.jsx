    ...
    <div className="min-h-screen bg-[#000000] text-white font-body overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block text-[10px] text-[#FFC72C]/70 leading-none tracking-widest uppercase">by SkyWave AI</span>
            </div>
          </div>
      ...
      <section className="relative pt-32 pb-24 px-6 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 2 }}>
          ...
          <div className="absolute top-1/2 left-1/4 w-[300px] h-[300px] rounded-full bg-[#FFC72C]/5 blur-[80px]" />
        </div>

        <div className="relative max-w-4xl mx-auto" style={{ zIndex: 3 }}>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#FFC72C]/40 bg-[#FFC72C]/10 text-[#FFC72C] text-xs font-semibold tracking-wide mb-6">
          ...
          <h1 className="font-heading font-bold text-5xl md:text-7xl leading-tight text-white mb-6">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFC72C] to-[#FFE08A]">SiteHawk</span> with AI<br />
              ...
              {[
                ...
                <div key={c.label} className="rounded-xl border border-white/5 bg-white/5 p-4 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-[#FFC72C]">{c.label}</span>
                  ...
                  <div className="pt-1 space-y-1 border-t border-white/5">
                    <p className="text-[10px] text-[#FFC72C]/80">✈ {c.airport}</p>
                    <p className="text-[10px] text-[#FFC72C]/70">📡 {c.tower}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-widest text-[#FFC72C] font-bold mb-3">Everything You Need</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((f) => (
              <div key={f.title} className="rounded-2xl border border-white/5 bg-white/3 hover:bg-white/5 hover:border-[#FFC72C]/25 p-6 transition-all group">
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3 className="font-heading font-bold text-white text-lg mb-2 group-hover:text-[#FFC72C] transition-colors">{f.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step} className="relative">
                <div className="text-[10px] font-black text-[#FFC72C]/50 tracking-widest mb-3">{s.step}</div>
      ...
      <section id="testimonials" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-widest text-[#FFC72C] font-bold mb-3">What Professionals Say</p>
      ...
      <section id="pricing" className="py-24 px-6 bg-gradient-to-b from-transparent to-[#121212]/40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#FFC72C]/30 bg-[#FFC72C]/10 text-[#FFC72C] text-sm font-semibold mb-6">
          ...
          <Link to="/pricing" className="text-[#FFC72C] hover:text-[#FFD75E] text-sm font-semibold underline underline-offset-4 transition-colors">
