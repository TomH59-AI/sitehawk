...
import { Upload, Eye, AlertTriangle, CheckCircle, Info, Loader2, MapPin } from "lucide-react";
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Upload aerial imagery or blueprints for AI-powered infrastructure suitability analysis</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl border border-border bg-card p-4 space-y-3">
            <h3 className="font-heading font-semibold text-sm text-foreground uppercase tracking-wider">Analysis Type</h3>
          ...
          <div className="rounded-xl border border-border bg-card p-4 space-y-3">
            <h3 className="font-heading font-semibold text-sm text-foreground uppercase tracking-wider flex items-center gap-2">
              <MapPin className="w-4 h-4 text-muted-foreground" /> Location Context (optional)
            </h3>
