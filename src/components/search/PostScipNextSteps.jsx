...
import { MapPin, ClipboardList, PhoneCall, FileSignature, Scale, Briefcase } from "lucide-react";
...
const NEXT_STEPS = [
  ...
  { path: "/crm", icon: Briefcase, label: "Time Savers", desc: "Mailers, CRM, and outreach tools." },
