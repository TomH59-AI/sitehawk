...
export const TOUR_STOPS = [
  ...
  },
  {
    ...
    narration:
      "Welcome to SiteHawk Document and Permit Intelligence — your AI-powered hub for automating the tedious paperwork side of wireless site acquisition. This page combines three heavy-hitting features designed to save you hours of hunting for municipality forms, reviewing complex leases, and filling out zoning applications. First, HawkFetch — Find Zoning and Permit Applications. It instantly locates local jurisdiction permit applications, zoning guidelines, and portal links across the U.S. without you having to dig through messy municipal websites. Type in the jurisdiction — city or county — select the state, and click Fetch Applications. HawkFetch pulls up the exact zoning and permit applications and online portal links for that local government agency. Second, Hawk Document Intelligence. It uses 20/20 Hawk AI Vision to OCR, read, and analyze complex site acquisition files — from multi-page land leases and redline counteroffers to municipal permit applications. It extracts key clauses, explains cryptic form fields, and auto-fills candidate and applicant data where possible. Drag and drop or upload your PDF, permit form, or lease draft into the Hawk Document Intelligence panel. The AI scans it, generates a summary breakdown, flags key requirements or redlines, and auto-populates known site and company data directly into the application fields. Third, the complete document workflow for leases and redlines keeps your entire paperwork trail — permit applications, lease analysis, and redline counters — synchronized in one central dashboard under your project. Pro tip: keep your project address and candidate details populated in SiteHawk first. That way, when you upload a permit through Hawk Document Intelligence, the bot can auto-fill the applicant and parcel information for you.",
  },
  {
    path: "/hawk-law",
