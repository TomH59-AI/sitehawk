...
export default function HubSpotSidebarConnect() {
  return (
    <Link
      to="/hubspot"
      className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-slate-100 transition-all duration-200 group"
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs font-semibold text-slate-800 group-hover:text-black leading-tight">
          HubSpot CRM
        </div>
