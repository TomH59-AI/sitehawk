...
export function toLegacyShape(rec) {
  ...
  return {
    ...
    required_collocations_count: rec.required_collocations_count ?? null,
    measured_from: rec.measured_from ?? null,
    landscaping_required: rec.landscaping_required ?? null,
    landscaping_details: rec.landscaping_details ?? null,
    zoning_process: rec.zoning_process ?? null,
    zoning_approval_timeframe: rec.zoning_approval_timeframe ?? null,
