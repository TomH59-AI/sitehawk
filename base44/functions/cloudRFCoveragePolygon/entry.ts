...
Deno.serve(async (req) => {
  try {
    ...
    const payload = {
      ...
      network: "SiteHawk",
      transmitter: { lat, lon, alt: txHeightM, frq: preset.frequency_mhz, txw: preset.power_w, bwi: 10, powerUnit: "W" },
      receiver: { lat: 0, lon: 0, alt: 2, rxg: 2, rxs: threshold_dbm },
      antenna: { txg: preset.antenna_gain_dbi, txl: 0, ant: 1, azi: 0, tlt: 0, hbw: preset.hbw, vbw: 30, fbr: 0, pol: "v" },
